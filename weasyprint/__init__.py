...
class HTML:
    ...
    def write_pdf(self, target=None, stylesheets=None, zoom=1,
                  ...
                  image_cache=None, byteio_images_info=None):
        ...
        return (
            self.render(
                ...
                counter_style=counter_style, image_cache=image_cache, byteio_images_info=byteio_images_info)
